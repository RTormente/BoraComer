...
function filterSlide(obj, qtd) {
    ...
    for (let i = obj.length - qtd; i < obj.length; i++) {
        ...
        item.url = obj[i].hasOwnProperty("idEstabelecimento")
            ? "restaurante_indicado.html?idRestaurante=" + obj[i].idEstabelecimento
            : "receita_completa.html?receitaID=" + obj[i].idReceita;
